...
```{r}
hist(dds.discr$age, breaks = seq(0, 100, by = 5))
...
A:In this case, the tapply function appears to use the function 'mean' to compute the average expenditures for each age.cohort within the hispanic and non-hispanic white categories.
